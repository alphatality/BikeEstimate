...
def dichotomie(mat,debut,fin,objectif,n,nmax):
    ...
    if debut == nmax or abs(fin-nmax==1):
        return dichotomie(mat,nb_actuel,2*nmax,objectif,n,2*nmax)
    if (fin==debut) or abs(fin-debut)==1:
        return (m,nb_actuel,res)
    if m>objectif:
        return dichotomie(mat,nb_actuel,fin,objectif,n,nmax)
    elif m< objectif:
        return dichotomie(mat,debut,nb_actuel,objectif,n,nmax)
    else :
        return (m,nb_actuel,res)
